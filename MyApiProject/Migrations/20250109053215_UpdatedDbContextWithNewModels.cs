...
{
    /// <inheritdoc />
    public partial class UpdatedDbContextWithNewModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarsPerUnit = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscountCodes_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountCodes_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StarTransactions_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StarTransactions_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodes_BusinessId",
                table: "DiscountCodes",
                column: "BusinessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodes_CustomerId",
                table: "DiscountCodes",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StarTransactions_BusinessId",
                table: "StarTransactions",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_StarTransactions_CustomerId",
                table: "StarTransactions",
                column: "CustomerId");
        }
